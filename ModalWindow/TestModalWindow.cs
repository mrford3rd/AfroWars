...
public class TestModalPanel : MonoBehaviour {
    ...
    public void TestLambda () {
        modalPanel.Choice ("Do you want to create this sphere?", () =>{ InstantiateObject(thingToSpawn); }, TestNoFunction);// modalPanel.Choice ("Do you want to create this sphere?", () =>{ InstantiateObject(thingToSpawn); }, myNoAction);}
    
    public void TestLambda2 () {
        modalPanel.Choice ("Do you want to create two spheres?", () =>{ InstantiateObject(thingToSpawn, thingToSpawn); }, TestNoFunction);//   modalPanel.Choice ("Do you want to create two spheres?", () =>{ InstantiateObject(thingToSpawn, thingToSpawn); }, myNoAction);}
    
    public void TestLambda3 () {
        modalPanel.Choice ("Do you want to create three spheres?", () =>{ InstantiateObject(thingToSpawn); InstantiateObject(thingToSpawn, thingToSpawn); }, TestNoFunction);//    modalPanel.Choice ("Do you want to create three spheres?", () =>{ InstantiateObject(thingToSpawn); InstantiateObject(thingToSpawn, thingToSpawn); }, myNoAction);}
